...
if ((mF>0)&&(view[CCW[xn+7]].color==LA)&&dOK[CCW[xn+7]]) {return {cell:CCW[xn+5],type:AJM};
...
} else if ((aF[ASF]>0)&&(view[CCW[xn+4]].color!=LRR1X)) {
return {cell:CCW[xn+4],color:LRR1X};
} else if ((aF[ASF]==0)&&(!LCRGRR1[view[CCW[xn+4]].color])&&
!(view[CCW[xn+4]].ant&&view[CCW[xn+4]].ant.friend)) {
...
view[CCW[xn+3]].ant&&view[CCW[xn+3]].ant.friend&&dOK[CCW[xn+4]]) {return {cell:CCW[xn+4]};} else if (dOK[CCW[xn+3]]) {return {cell:CCW[xn+3]};} else if (dOK[CCW[xn+5]]) {return {cell:CCW[xn+5]};} else {return NOP;}} else if (spcRM()) {return (rUTRRSy());}return (rLostMSy(false));}function rULRL02Sy() {var ptrn;var msm;if (sL[LRM0]>0) {ptrn=PTGRL0;msm=patC(ptrn,AIMR,1,1);}if (xn<0) {ptrn=PTGRL2;msm=patC(ptrn,AIMR,1,1);}if (xn>=0) {if (view[CCW[xn+3]].ant&&view[CCW[xn+3]].ant.friend&&dOK[CCW[xn+4]]) {return {cell:CCW[xn+4]};} else if (dOK[CCW[xn+3]]) {return {cell:CCW[xn+3]};} else if (dOK[CCW[xn+5]]) {return {cell:CCW[xn+5]};} else {return NOP;}} else if (spcRM()) {return (rUTRRSy());}return (rLostMSy(false));}function rULRR0Sy() {var ptrn=PTGRR0;msm=patC(ptrn,AIML,2,1);if (xn>=0) {return (runUMLeaveRRTactic());} else if (spcRM()) {return (rUTRRSy());}return (rLostMSy(false));}function rULRR2Sy() {var ptrn=PTGRR2;msm=patC(ptrn,AIML,2,1);if (xn>=0) {return (runUMLeaveRRTactic());}    return (rLostMSy(false));}function rUPSSy() {var ptrn=PTGRR1;var msm=patC(ptrn,AIMD,3,2);if (xn>=0) {if ((view[CCW[xn+2]].color==LMX_M3OUT)&&
...
) {if (dOK[CCW[xn+5]]) {return {cell:CCW[xn+5]};} else if (dOK[CCW[xn+4]]) {return {cell:CCW[xn+4]};} else if (dOK[CCW[xn+6]]) {return {cell:CCW[xn+6]};} else {return NOP;}} else if (mC!=LRR1U) {return {cell:POSC,color:LRR1U};
} else if (msm<0) {var cc=fwdWrong[0];return {cell:cc.v,color:fixup(ptrn[cc.p])};
} else {var c=CCW[xn+1];if (dOK[c]) {return {cell:c};} else if (view[c].ant&&view[c].ant.friend) {
if (dOK[CCW[xn+5]]) {return {cell:CCW[xn+5]};} else if (dOK[CCW[xn+4]]) {return {cell:CCW[xn+4]};} else if (dOK[CCW[xn+6]]) {return {cell:CCW[xn+6]};} else {return NOP;}} else {return NOP;}}}return (rLostMSy(false));}function rUESSy() {var ptrn=PTMS0R_IN;var msm=patC(ptrn,AIMD,4,2);if (xn>=0) {return (rUESTc(ptrn,msm));}return (rLostMSy(false));}function rUDSSy() {var ptrn;var msm;if ((sL[LML3]>=1)&&(sD[LMR2]+sD[LMR0]>=1)) {ptrn=PTMS3;msm=patC(ptrn,AIMD,3,2);}if ((xn<0)&&(sL[LMR2]>=1)&&(sD[LML1]+sD[LML3]>=1)) {ptrn=PTMS2;msm=patC(ptrn,AIMD,3,2);}if ((xn<0)&&(sL[LML1]>=1)&&(sD[LMR0]+sD[LMR2]>=1)) {ptrn=PTMS1_IN;msm=patC(ptrn,AIMD,3,4);if (xn<0) {ptrn=PTMS1;msm=patC(ptrn,AIMD,3,2);}}if (xn>=0) {return (rUDSTc(ptrn,msm));}if ((sD[LML3]+sL[LMR0]>=2)&&(sD[LRL0] >=2)&&(sD[LML1]==0)) {
...
}ptrn=PTMS0_WRAPPING;msm=patC(ptrn,AIMD,0,1);if (xn>=0) {return (rLWRTc(ptrn,msm));}}if ((sL[LMR0]>=1)&&(sD[LML3]+sD[LML1]>=1)) {ptrn=PTMS0;msm=patC(ptrn,AIMU,3,2);if (xn>=0) {return (rLASTc(ptrn,msm));}}if (spcRM()) {return (rLTRRSy());}return (rLostMSy(false));}function rLLSSy() {var ptrn=PTMS0R_OUT;var msm=patC(ptrn,AIMU,0,1);if (xn>=0) {} else {ptrn=PTMS0R_IN;msm=patC(ptrn,AIMU,4,2);if (xn>=0) {ptrn=PTMS0R_OUT;msm=patC(ptrn,AIMU,0,1);}}if (xn>=0) {return (rLLSTc(ptrn,msm));} else if (spcMS()) {return (rLASSy());}return NOP;}function rLLVSSy() {var ptrn=PTMS0R_OUT1;var msm=patC(ptrn,AIMU,0,1);if (xn>=0) {if (view[CCW[xn+3]].color==LCLR) {
return {cell:CCW[xn+3],color:((mT==ASM) ? LMX_M2OUT : LMX_M1OUT)};
} else if (dOK[CCW[xn+5]]) {return {cell:CCW[xn+5]};} else {return NOP;}} else if (spcMS()) {return (rLASSy());}return (rLostMSy(false));}function rLDSSy() {var ptrn=PTGRR1;var msm=patC(ptrn,AIMU,1,1);if (xn>=0) {if ((view[CCW[xn]].color==LMR0)&&
...
}}if (dOK[CCW[xn+5]]) {return {cell:CCW[xn+5]};} else if (dOK[CCW[xn+6]]) {return {cell:CCW[xn+6]};} else {return NOP;}}return (rLostMSy(false));}function rLTRRSy() {return (rLCRTc());}function rLFRSy() {return NOP;}function rLRHSy() {var ptrn=PTFRL1G;var msm=patC(ptrn,AIMR,0,1);if (xn>=0) {return (rLRLTc());}return NOP;}function rLLRL1Sy() {var ptrn=PTGRL1;var msm=patC(ptrn,AIMR,0,1);if (xn>=0) {return (rLRLTc());} else if (spcRM()) {return (rLTRRSy());}return (rLostMSy(false));}function rLLRL02Sy() {var ptrn;var msm;if (sL[LRM0]>0) {ptrn=PTGRL0;msm=patC(ptrn,AIMR,1,1);}if (xn<0) {ptrn=PTGRL2;msm=patC(ptrn,AIMR,1,1);}if (xn>=0) {return (rLRLTc());}return (rLostMSy(false));}function rLLRR0Sy() {var ptrn=PTGRR0;msm=patC(ptrn,AIML,2,1);if (xn>=0) {return (rLRRTc());} else if (spcRM()) {return (rLTRRSy());}return (rLostMSy(false));}function rLLRR2Sy() {var ptrn=PTGRR2;msm=patC(ptrn,AIML,2,1);if (xn>=0) {return (rLRRTc());} else if (spcRM()) {return (rLTRRSy());}return (rLostMSy(false));}function rLCRSy() {for (var i=TN; i>=1; i--) {if (!dOK[CCW[i]]&&dOK[CCW[i-1]]) {
...
dOK[CCW[xn+3]]) {return {cell:CCW[xn+3]};}}var c=CCW[xn+5];if (dOK[c]) {return {cell:c};} else if (view[c].ant&&view[c].ant.friend) {
...
} else if ((msm>=0)&&dOK[c]) {return {cell:c};}return NOP;}function rLLSTc(ptrn,msm) {if (msm<0) {var cc=fwdWrong[0];return {cell:cc.v,color:fixup(ptrn[cc.p])};
...
view[CCW[xn+7]].ant.friend)) {return {cell:POSC,color:LRM1};}}}if (xn<0) {return (rLostMSy(false));}if (msm==0) {var c=CCW[xn+1];if (dOK[c]) {return {cell:c};} else if (view[c].ant&&view[c].ant.friend) {
